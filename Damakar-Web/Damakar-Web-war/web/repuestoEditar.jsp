<%-- 
    Document   : repuestoEditar
    Created on : 12/10/2018, 03:53:14 PM
    Author     : Kata
--%>
...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="divTitulo row"><H1 style="margin: 40px 0;">Editar REPUESTO</H1></div> 
      <div class="formulario" style="margin:10px">
        <form action="#" method="post">
          ...
          <button type="submit" class="btn btn-primary" name="action" value="agregaRepuesto">Guardar cambios</button>
