...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="divTitulo row"><H1 style="margin: 40px 0;">AGREGAR MARCA</H1></div> 
      <div class="formulario" style="margin:10px">
        <form action="#" method="post">
          ...
          <button type="submit" class="btn btn-primary" name="action" value="agregarMarca">Agregar</button>
