<%-- 
    Document   : mecanicoEditar
    Created on : 11/10/2018, 10:03:09 PM
    Author     : Kata
--%>
...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="divTitulo row"><H1 style="margin: 40px 0;">editar mecanico</H1></div> 
      <div class="formulario" style="margin:10px">
        <form action="#" method="post">
          ...
          <button type="submit" class="btn btn-primary" name="action" value="editarMecanico">Guardar Cambios</button>
