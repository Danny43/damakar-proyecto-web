...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="divTitulo row"><H1 style="margin: 40px 0;">EDITAR RESERVA</H1></div> 
      <div class="formulario" style="margin:10px">
        <form action="#" method="post">
          ...
          <button type="submit" class="btn btn-primary" name="action" value="editarReserva">Guardar CAMBIOS</button>
          <a href="reservaListar.jsp" class="btn btn-primary btn-sm">Ver todas <br> las reservas</a>
        </form>
      </div>
