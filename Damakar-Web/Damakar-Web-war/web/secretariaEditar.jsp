<%-- 
    Document   : secretariaEditar
    Created on : 11/10/2018, 09:49:38 PM
    Author     : Kata
--%>
...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="divTitulo row"><H1 style="margin: 40px 0;">EDITAR secretaria</H1></div> 
      <div class="formulario" style="margin:10px">
        <form action="#" method="post">
          ...
          <button type="submit" class="btn btn-primary" name="action" value="editarSecretaria">guardar cambios</button>
