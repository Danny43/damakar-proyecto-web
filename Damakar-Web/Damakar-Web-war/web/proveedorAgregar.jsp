<%-- 
    Document   : proveedorAgregar
    Created on : 12/10/2018, 04:05:14 PM
    Author     : Kata
--%>
...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="divTitulo row"><H1 style="margin: 40px 0;">AGREGAR PROVEEDOR</H1></div> 
      <div class="formulario" style="margin:10px">
        <form action="#" method="post">
          ...
          <button type="submit" class="btn btn-primary" name="action" value="agregarProveedor">Agregar</button>
