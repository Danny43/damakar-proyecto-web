<%-- 
    Document   : dtcAgregar
    Created on : 12/10/2018, 10:15:23 AM
    Author     : Kata
--%>
...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="divTitulo row"><H1 style="margin: 40px 0;">AGREGAR dtc</H1></div> 
      <div class="formulario" style="margin:10px">
        <form action="#" method="post">
          <div class="form-group">
            <label for="txtDTC">NOMBRE DTC</label>
            <input type="text" class="form-control" id="txtDTC" name="txtDTC" placeholder="P2211" maxlength="5">
          </div>
          <div class="form-group">
            <label for="txtDescripcion">DESCRIPCIÓN</label>
            <input type="text" class="form-control" id="txtDescripcion" name="txtDescripcion">
          </div>
          <button type="submit" class="btn btn-primary" name="action" value="agregarDTC">Agregar</button>
          <a href="dtcListar.jsp" class="btn btn-primary btn-sm">Ver todos <br> los DTC</a>
        </form>
      </div>
