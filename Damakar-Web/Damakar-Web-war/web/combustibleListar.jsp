...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="divTitulo row"><H1 style="margin: 40px 0;">LISTA DE combustibles</H1></div> 
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            <th scope="col"><a class="btn btn-primary btn-sm" href="combustibleEditar.jsp">Modificar</a></th>
